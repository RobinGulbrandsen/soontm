...
var countdownHandler = function countdownHandler() {
    var _second = 1000;
    ...
    var getRemainingTime = function getRemainingTime(countDownTo) {
    ...
    return { getRemainingTime: getRemainingTime };
};

exports["default"] = countdownHandler;
...
var _jsCountdownHandler = require("./js/countdownHandler");

var _jsCountdownHandler2 = _interopRequireDefault(_jsCountdownHandler);

(function () {
	var countdown = (0, _jsCountdownHandler2["default"])();
	var _countDownTo = undefined;
	...
	var clockEngine = function clockEngine() {
		setTimeout(function () {
			var remaining = countdown.getRemainingTime(_countDownTo);
	...
	var setBackgroundImage = function setBackgroundImage(url, stretched) {
		var styling = "";
		...
		if (stretched) {
			...
			var img = new Image();
			img.onload = function () {
				styling += "margin-top: 1em;" + "width: " + this.width + ";" + "height: " + this.height + ";" + "background-image: url('" + url + "');";
				document.getElementById("wrapper").style = styling;
			};
			img.src = url;
		}
	...
	var initPage = function initPage() {
		var displayText = getQueryParameterByName('text');
		document.getElementById("text").innerHTML = displayText;

		_countDownTo = new Date(Number(getQueryParameterByName('date')));
		clockEngine();

		var isStretched = getQueryParameterByName('stretched') === "true";

		var protocol = getQueryParameterByName('protocol');
		var url = getQueryParameterByName('image');
